...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_comments_messages2_idx` (`message_id`),
  KEY `fk_comments_users2_idx` (`user_id`),
  CONSTRAINT `fk_comments_messages2` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-09-13 17:20:21
